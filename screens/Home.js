...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      listData: [],
      imagePath: "",
      url: " https://1356-67-161-17-206.ngrok.io",
    };
  }
  ...
  getPlanets = () => {
    ...
    axios .get(url) .then((response) => { this.setState({ listData: response.data.data, }); })
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View style={styles.lowerContainer}>
             <FlatList keyExtractor={this.keyExtractor} data={this.state.listData} renderItem={this.renderItem} numColumns={2} />
